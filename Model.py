...
pickle.dump(final_svm_model, open('model_svm.pkl', 'wb'))
pickle.dump(final_nb_model, open('model_nb.pkl', 'wb'))
pickle.dump(final_rf_model, open('model_rf.pkl', 'wb'))
pickle.dump(encoder, open('encoder.pkl', 'wb'))

# Testing the function
# print(predictDisease("Itching,Skin Rash,Nodal Skin Eruptions"))
# print(predictDisease("Shivering,Fatigue,Vomiting"))
